<template>
  <div class="main">
    ...
    <div class="loader">
      <div class="song">
        <div class="name">Time in a Bottle</div>
        <div class="artist">Jim Corce</div>
      </div>
    ...
    <div class="loader">
      <div class="song">
        <div class="name">Lemon Tree</div>
        <div class="artist">Fools Garden</div>
      </div>
      <div class="albumcover"></div>
      <div class="play"></div>
    </div>
...
.load {
  ...
  background: linear-gradient(126deg, rgba(0, 210, 255, 0.99), rgba(58, 76, 254, 0.99));
}
